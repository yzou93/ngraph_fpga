...
#
# Generated by export_simulation on Mon Feb 19 23:01:19 EST 2018
#
################################################################################
...
switch to the './node_in_strm.sh' script.

./node_in_strm.sh -reset_run
...
./node_in_strm.sh -noclean_files

For more information on the script, please type './node_in_strm.sh -help'.
