...
#
# Generated by export_simulation on Mon Feb 19 23:34:56 EST 2018
#
################################################################################
...
switch to the './node_out_strm.sh' script.

./node_out_strm.sh -reset_run
...
./node_out_strm.sh -noclean_files

For more information on the script, please type './node_out_strm.sh -help'.
