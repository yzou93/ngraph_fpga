...
#
# Generated by export_simulation on Wed Feb 21 03:31:17 EST 2018
#
################################################################################
...
switch to the './wt_rom.sh' script.
...
./wt_rom.sh -noclean_files

For more information on the script, please type './wt_rom.sh -help'.
