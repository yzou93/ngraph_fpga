...
HD_PWD='/home/yuzou/gcn_fpga_exp1/gcn_fpga_hw/gcn_fpga_hw.runs/msg_in_strm_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log msg_in_strm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source msg_in_strm.tcl
