...
HD_PWD='/home/yuzou/gcn_fpga_exp1/gcn_fpga_hw/gcn_fpga_hw.runs/edge_strm_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log edge_strm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source edge_strm.tcl
