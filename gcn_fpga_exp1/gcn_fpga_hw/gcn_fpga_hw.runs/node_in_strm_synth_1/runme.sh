...
HD_PWD='/home/yuzou/gcn_fpga_exp1/gcn_fpga_hw/gcn_fpga_hw.runs/node_in_strm_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log node_in_strm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source node_in_strm.tcl
