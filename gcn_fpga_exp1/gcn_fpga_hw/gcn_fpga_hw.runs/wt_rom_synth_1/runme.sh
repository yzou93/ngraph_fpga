...
HD_PWD='/home/yuzou/gcn_fpga_exp1/gcn_fpga_hw/gcn_fpga_hw.runs/wt_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wt_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wt_rom.tcl
