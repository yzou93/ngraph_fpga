...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(wt_ce0, ap_clk, ap_rst, ap_start, ap_done, ap_idle, 
  ...
  metadata_strm_V_empty_n, metadata_strm_V_read, msg_out_strm_V_din, 
  msg_out_strm_V_full_n, msg_out_strm_V_write, msg_in_strm_V_dout, msg_in_strm_V_empty_n, 
  msg_in_strm_V_read, node_out_strm_V_din, node_out_strm_V_full_n, node_out_strm_V_write, 
  wt_address0, wt_q0)
/* synthesis syn_black_box black_box_pad_pin="wt_ce0,ap_clk,ap_rst,ap_start,ap_done,ap_idle,ap_ready,node_in_strm_V_dout[31:0],node_in_strm_V_empty_n,node_in_strm_V_read,edge_strm_V_src_V_dout[14:0],edge_strm_V_src_V_empty_n,edge_strm_V_src_V_read,edge_strm_V_dst_V_dout[14:0],edge_strm_V_dst_V_empty_n,edge_strm_V_dst_V_read,edge_strm_V_c_dout[31:0],edge_strm_V_c_empty_n,edge_strm_V_c_read,metadata_strm_V_dout[63:0],metadata_strm_V_empty_n,metadata_strm_V_read,msg_out_strm_V_din[31:0],msg_out_strm_V_full_n,msg_out_strm_V_write,msg_in_strm_V_dout[31:0],msg_in_strm_V_empty_n,msg_in_strm_V_read,node_out_strm_V_din[31:0],node_out_strm_V_full_n,node_out_strm_V_write,wt_address0[12:0],wt_q0[31:0]" */;
  ...
  input [14:0]edge_strm_V_src_V_dout;
  input edge_strm_V_src_V_empty_n;
  output edge_strm_V_src_V_read;
  input [14:0]edge_strm_V_dst_V_dout;
